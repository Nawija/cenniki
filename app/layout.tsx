        ...
        <html lang="pl">
            <body className="m-0 font-sans">
                <div className="flex min-h-screen">
                    <aside className="w-[250px] bg-gradient-to-b fixed h-screen top-0 from-gray-900 to-gray-800 text-white p-5 block">
                    ...
                    <main className="flex-1 ml-[250px] p-5 bg-gradient-to-t from-blue-50 to-gray-100 text-gray-800">
                        {children}
                    </main>
                </div>
            </body>
