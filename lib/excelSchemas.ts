...
export const PRODUCER_SCHEMAS: Record<string, ProducerExcelSchema> = {
    ...
    benix: {
        ...
        columnPatterns: {
            name: [/^nazwa$/i, /^produkt$/i, /^model$/i, /^name$/i],
            element: [/^element$/i, /^kod$/i, /^code$/i, /^symbol$/i],
            priceGroups: [
                {
                    group: "Grupa 6",
                    patterns: [/^grupa\s*6$/i, /^g6$/i, /^6$/],
                },
                {
                    group: "Grupa 5",
                    patterns: [/^grupa\s*5$/i, /^g5$/i, /^5$/],
                },
                {
                    group: "Grupa 4",
                    patterns: [/^grupa\s*4$/i, /^g4$/i, /^4$/],
                },
                {
                    group: "Grupa 3",
                    patterns: [/^grupa\s*3$/i, /^g3$/i, /^3$/],
                },
                {
                    group: "Grupa 2",
                    patterns: [/^grupa\s*2$/i, /^g2$/i, /^2$/],
                },
                {
                    group: "Grupa 1",
                    patterns: [/^grupa\s*1$/i, /^g1$/i, /^1$/],
                },
            ],
        },
    },
