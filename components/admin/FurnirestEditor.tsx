...
export function FurnirestEditor({ data, onChange, producer }: Props) {
    ...
    const addProduct = (catName: string) => {
        ...
        if (existingProducts.length > 0 && existingProducts[0].priceMatrix) {
...
// ============================================
// PRODUCT EDITOR WITH PRICE MATRIX
// ============================================
            ...
            <div className="space-y-3">
                ...
                {matrix.groups.length === 0 && matrix.columns.length === 0 && (
                    <p className="text-sm text-gray-400 text-center py-4">
                        Dodaj grupy cenowe i warianty, aby stworzyć macierz cen
                    </p>
                )}
            </div>
